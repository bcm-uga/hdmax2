...
# First Example:  *Binary exposure* and *continuous outcome*
...
```{r plot results univar , fig.height=10, fig.width=10 , message=FALSE, warning=FALSE, fig.show='asis'}
library(ggplot2)
...
Please refer to previous example for figures comments.
