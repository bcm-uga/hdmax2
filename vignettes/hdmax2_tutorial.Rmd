...
```{r step 1 res AS, message=FALSE, fig.height=5, fig.width=12}
...
p1 = ggplot(data = data.frame(x = pval1, y = pval2), aes(x = pval1, y = pval2)) +
  geom_bin2d(bins = 50) +  # Ajuste le nombre de bins selon le besoin
...
#title_grob <- grid::textGrob("Hypothesis verification")#, gp = grid::gpar(fontsize = 16, fontface = "bold"))
...
#   print("Downloading TCGA BRCA dataset from zenodo 10.5281/zenodo.14716548")
#   zen4R::download_zenodo( doi = "10.5281/zenodo.14716548", 
#                         files = "tcga_brca.RData",
#                         timeout = 3600)
# }  
...
#   print("Downloading Multiple Sclerosis dataset from zenodo 10.5281/zenodo.14716548")
#   zen4R::download_zenodo( doi = "10.5281/zenodo.14716548", 
#                         files = "ms_GSE137143.RData",
#                         timeout = 3600)
# }  
...
```{r ms step2 multivar, message=FALSE}
hdmax2_step2 = hdmax2::estimate_effect(object = hdmax2_step1,
                                       m = mediators_top10)
```
...
```{r ms plot results multivar , fig.height=10, fig.width=10, fig.show='asis'}
hdmax2::plot_hdmax2(hdmax2_step2, plot_type= "all_plot")
```
