...
# First use case  *univariate binary exposure* and *continuous outcome*
...
## Mediators individual indirect effects estimation and Overall Indirect effect estimation.
...
We propose a set of plots wich include:
...
# Use case 2  **univariate continuous exposure** and **continuous outcome**
...
# Use case 4 **categorial exposure** and **binary outcome**



## First option a single pvalue results via partial regression
...
### Second option multimediate results, pvalu and mediators selection for each category of the exposure
