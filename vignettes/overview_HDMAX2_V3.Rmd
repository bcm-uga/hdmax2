...
X_categorial = as.matrix(simu_data$X_categorial)
...
res_step2 = hdmax2::estimate_effect(X = X_binary,
                                    Y = Y_continuous,
                                    m = mediators_top10,
                                    covar = cbind(age, gender),
                                    U = res_step1$mod1$U,
...
hdmax2::plot_hdmax2(res_step2, N_med = 10)
```
...
```{r}
## selected mediators effects estimation
res_step2 = hdmax2::estimate_effect(
  X = X_continuous,
  Y = Y_continuous,
  m = mediators_top10,
  covar = cbind(age, gender),
...
```{r}
## mediators ACME plots 
hdmax2::plot_summary_ACME(ACME = res_step2$ACME)
```
