...
# # oie for each level of probes selection
# oie = NULL
# for (i in c(2:60)) {
# m = M[,names(sort(res_step1$max2)[1:i])]
# X=X
# C=res_step1$mod1$U 
# m = m
# Y=Y
...
# }
# 
# plot(oie~c(2:60), type = "l", ylim = c(-1,0) )
```
...
res_step1 = hdmax2::run_AS(X_matrix = X ,
                 ...
                 K = K,
                 X_type = "multivariate",
                 Y_type = "continuous", #even it is binary
                 M_type = "methylation",
                 conf = NULL,
                 diagnostic.plot = F)
