...
mediators = M[,names(sort(res_step1$max2)[1:10])]
mediators
...
res_oie = hdmax2::estimate_OIE(X=X, C=res_step1$mod1$U, m = mediators, Y=Y, boots = 100 )
median(res_oie)
...
res_oie = hdmax2::estimate_OIE(X=X, C=res_step1$mod1$U, m = m = mediators, Y=Y, boots = 100 )
median(res_oie)
boxplot(res_oie, horizontal =F, main = "OIE estimation 100 bootstraps", col = "blue")
```
