...
For the two examples we will use a continuous outcome and two covariates (age and gender).
...
```
We obtained three sets, for each category of categorial exposure (minus the reference category), of 4 plots:
...
We obtained two sets, for each variables of multivariate exposure, of 4 plots:
