...
- $X$ can be a vector, a factor with $n$ (samples) elements or a data frame with  $n$ rows and 1 column.
...
- Latent factors estimation matrix ($p$ rows and $k$ columns) from first regression, 
...
```{r plot results, fig.height=11, fig.width=10 , message=FALSE, warning=FALSE}
library(ggplot2)
