 ...
 plot_final = list()
  ...
  for(k in 1:n_cat){
    ...
    df_effect = data.frame(OIE = object$oie_med[[1]][[k]], # median of OIE
                           ...
                           ODE =  object$ode[[1]][[k]][1], # coefficient of direct effect linear regression
                           ODE_sd =  object$ode[[1]][[k]][2], # sd of direct effect linear regression
                           OTE =  object$ote[[1]][[k]][1], # coefficient of total effect linear regression
                           OTE_sd =  object$ote[[1]][[k]][2]) # sd of total effect linear regression
    df_effect_long <-
      reshape(
        df_effect,
        varying = list(c("OIE", "ODE", "OTE"), c("OIE_CI", "ODE_sd", "OTE_sd")),
