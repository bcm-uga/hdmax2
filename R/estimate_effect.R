...
##'  
##' Regressions:
##'  - xm_size_effect, regression effects X on M
##'  - my_size_effect, regression effects M on Y
##' 
##' 
##' Overall effect
...
estimate_effect <- function(object , m, boots = 100, sims = 3) {
  ...
  if (class(object)!="hdmax2_step1"){
    stop("The object is not of class hdmax2_step1. This function only use hdmax2 objects generated by hdmax2::run_AS")
  }
